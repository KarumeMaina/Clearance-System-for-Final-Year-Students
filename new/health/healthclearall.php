                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($show)
						{
							...
							{
								 $ch=mysqli_query($conn,"select * from department_health where idnumber='$studentid'");
								 $hc=mysqli_fetch_array($ch);
								 $basket=$hc['basket'];
								 if($basket=='')
								 {
								 	$update=mysqli_query($conn,"update department_health set clearance_status='1',basket='' where idnumber='$studentid'");
									if($update)
									{
