        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:green">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="icthome.php"><i class="fa fa-fw fa-dashboard"></i> <?php echo $_SESSION['ictlogin']; ?> Home</a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($incre)
						{
							$chk=mysqli_query($conn,"select * from department_ict where incre='$incre' && basket=''");
							$no=mysqli_num_rows($chk);
							if($no==1)
							{
							$update=mysqli_query($conn,"update department_ict set clearance_status='1',basket='' where incre='$incre'");
							if($update)
							{
								echo"Student has been successfully cleared in ict department list<br/><a href='ictclearedstudents.php'>Cleared Students</a>";
							}
							else
							{
								echo"student not successfully cleared<br/><a href='ictunclearedstudents.php'>Try Again</a>";
							}
							}
							else
							{
								echo"student not successfully cleared due to uncleared items<br/><a href='ictunclearedstudents.php'>Try Again</a>";
							}
						}
						else
						{
