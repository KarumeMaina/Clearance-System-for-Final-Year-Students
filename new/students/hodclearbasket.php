    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">hod clear student progress</h1>
						<p>
						<?php
						$incre=$_POST['incre'];
						if($incre)
						{
							$update=mysqli_query($conn,"update department_hod set basket='' where incre='$incre'");
							if($update)
							{
								echo"Student's basket has been successfully cleared in hod department list<br/><a href='hodunclearedstudents.php'>Clear Student</a>";
							}
							else
							{
								echo"student's basket not successfully cleared<br/><a href='hodunclearedstudents.php'>Try Again</a>";
							}
						}
						else
						{
