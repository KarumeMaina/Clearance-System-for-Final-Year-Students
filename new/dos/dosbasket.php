            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<textarea required style="width:100%;text-align:center;" name="basket" placeholder="enter amount ofitems owed by the student "></textarea><br/><br/>
						...
						<?php
						$year=date("Y");
						$query=mysqli_query($conn,"select * from department_dos where basket != ''");
