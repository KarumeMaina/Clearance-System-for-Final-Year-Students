    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">hod Basket addition progress</h1>
						<p>
						<?php
						...
						if($idnumber && $basket)
						{
							$query=mysqli_query($conn,"select * from department_hod where idnumber='$idnumber'");
							...
							{
								$update=mysqli_query($conn,"update department_hod set basket='$basket',clearance_status='2' where idnumber='$idnumber'");
								if($update)
								{
									echo"you have successfully added item(s) to student with admission number $idnumber<br/><a href='hodbasket.php'>View Basket</a>";
								}
								else
								{
