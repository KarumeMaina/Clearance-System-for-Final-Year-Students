            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<textarea required style="width:100%;text-align:center;" name="basket" placeholder="enter amount of items owed by the student(if many comma separate i.e item 1, item 2, item 3"></textarea><br/><br/>
