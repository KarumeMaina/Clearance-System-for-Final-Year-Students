            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($idnumber && $basket)
						{
							$query=mysqli_query($conn,"select * from department_library where idnumber='$idnumber'");
							...
							{
								$update=mysqli_query($conn,"update department_library set basket='$basket',clearance_status='2' where idnumber='$idnumber'");
								if($update)
								{
