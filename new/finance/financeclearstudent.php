            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($incre)
						{
							$chk=mysqli_query($conn,"select * from department_finance where incre='$incre' && basket=''");
							$no=mysqli_num_rows($chk);
							if($no==1)
							{
							$update=mysqli_query($conn,"update department_finance set clearance_status='1',basket='' where incre='$incre'");
							if($update)
							{
