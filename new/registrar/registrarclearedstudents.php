...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php
						$year=date('Y');
						$query=mysqli_query($conn,"select * from department_registrar where clearance_status='1'");
			...
			<footer style="text-align:left;background-color:green;color:#FFFFFF;" class="navbar navbar-default navbar-fixed-bottom">
