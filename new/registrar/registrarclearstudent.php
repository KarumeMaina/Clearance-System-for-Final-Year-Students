            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						if($incre)
						{
							$chk=mysqli_query($conn,"select * from department_registrar where incre='$incre' && basket=''");
							...
							if($no==1)
							{
								...
								$hodcheck=mysqli_query($conn,"select * from department_hod where idnumber='$studentid' && basket='' && clearance_status='1'");
								$hodno=mysqli_num_rows($hodcheck);
								if($hodno==1)
								{
									//start of dos clearance check
									$doscheck=mysqli_query($conn,"select * from department_dos where idnumber='$studentid' && basket='' && clearance_status='1'");
										...
										if($financeno==1)
										{
											...
											if($foodno==1)
											{
												...
												if($healthno==1)
												{
													...
													{
														//ict
														$ictcheck=mysqli_query($conn,"select * from department_ict where idnumber='$studentid' && basket='' && clearance_status='1'");
